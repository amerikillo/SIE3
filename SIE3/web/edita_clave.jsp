...
<%
    ...
    int PzxCaja = 0, tarimasC = 0, tarimasI = 0, cajasPorTarimaC = 0, cajasPorTarimaI = 0;
    try {
    ...
    try {
        con.conectar();
        ResultSet rset = con.consulta("select F_ClaPro, F_Lote, F_FecCad, F_FecFab, F_Marca, F_Cb, F_Cajas, F_Pz, F_Tarimas, F_Resto from tb_compratemp where F_IdCom = '" + ((String) sesion.getAttribute("id")) + "' ");
        while (rset.next()) {
            ...
            tarimasInc = rset.getString("F_Resto");
            ...
            PzxCaja = Integer.parseInt(piezas) / Integer.parseInt(cajas);
            ...
            cajasPorTarimaI = Integer.parseInt(cajas) % tarimasC;
        }
        con.cierraConexion();
    } catch (Exception e) {
